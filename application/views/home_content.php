<section class="feature_part">
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <div class=" d-flex align-items-center">
                                <img src="<?php echo base_url();?>assets/frontend_asset/img/icon/feature_1.svg" alt="">
                                <h4>Give Donation</h4>
                            </div>
                ...
                <div class="col-lg-5 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <div class=" d-flex align-items-center">
                                <img src="<?php echo base_url();?>assets/frontend_asset/img/icon/feature_2.svg" alt="">
                ...
                <div class="col-lg-5 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <div class=" d-flex align-items-center">
                                <img src="<?php echo base_url();?>assets/frontend_asset/img/icon/feature_3.svg" alt="">
                ...
                <div class="col-lg-5 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <div class=" d-flex align-items-center">
                                <img src="<?php echo base_url();?>assets/frontend_asset/img/icon/feature_4.svg" alt="">
    ...
    <section class="be_part">
        ...
        <img src="<?php echo base_url();?>assets/frontend_asset/img/Charity.jpg" alt="" class="be_img">
    </section>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-passion">
                        <div class="card">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/passion/passion_1.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li><img src="<?php echo base_url();?>assets/frontend_asset/img/icon/passion_1.svg" alt=""> Goal: $2500</li>
                                    <li><img src="<?php echo base_url();?>assets/frontend_asset/img/icon/passion_2.svg" alt=""> Raised: $1533</li>
                                </ul>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-passion">
                        <div class="card">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/passion/passion_2.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-passion">
                        <div class="card">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/passion/passion_3.png" class="card-img-top" alt="blog">
                            <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/volunteers/volunteers_1.png" alt="doctor">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/volunteers/volunteers_2.png" alt="doctor">
                            <div class="social_icon">
                                <a href="#"> <i class="ti-facebook"></i> </a>
                                <a href="#"> <i class="ti-twitter-alt"></i> </a>
                                <a href="#"> <i class="ti-instagram"></i> </a>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/volunteers/volunteers_3.png" alt="doctor">
                            <div class="social_icon">
                                <a href="#"> <i class="ti-facebook"></i> </a>
                                <a href="#"> <i class="ti-twitter-alt"></i> </a>
                                <a href="#"> <i class="ti-instagram"></i> </a>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/volunteers/volunteers_4.png" alt="doctor">
                            <div class="social_icon">
                                <a href="#"> <i class="ti-facebook"></i> </a>
                                <a href="#"> <i class="ti-twitter-alt"></i> </a>
                                <a href="#"> <i class="ti-instagram"></i> </a>
                ...
                <div class="col-lg-6">
                    <div class="single_blog">
                        <div class="appartment_img">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/blog_1.png" alt="">
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="client_logo owl-carousel">
                        <div class="single_client_logo">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/client_logo/Logo_1.png" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/client_logo/Logo_2.png" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/client_logo/Logo_3.png" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/client_logo/Logo_4.png" alt="">
                        </div>
                        <div class="single_client_logo">
                            <img src="<?php echo base_url();?>assets/frontend_asset/img/client_logo/Logo_5.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
